...
import { Lessons } from '../../../../generated/prisma/models/Lessons';
...
const rounderRow = (items: ResultsList) => (
  ...
  >
    ...
    <td className="hidden md:table-cell">{items.teacherName + " " + items.teacherSurname}</td>
    <td className="hidden md:table-cell">{items.className}</td>
    <td className="hidden md:table-cell">{new Intl.DateTimeFormat("en-GB").format(items.startTime)}</td>
    <td>
...
const ResultsListPage = async ({
  ...
  const data = dataRes.map((item) => {
    ...
    return {
      ...
      teacherName:assessment.lessons.teachers.name,
      teacherSurname: assessment.lessons.teachers.name,
      score:item.score,
