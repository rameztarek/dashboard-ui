...
const rounderRow = (items: TeacherList) => (
  <tr
    key={items.id}
  ...
  >
    ...
    <td>
      <div className="flex items-center gap-2">
        ...
        {role === "admin" && (
          <>
            <FormModle table="teachers" type="delete" id={items.id} />
          </>
        )}
      </div>
    </td>
...
const TeachersPage = as () => {

  const teacher = prisma.teacher.findMany()
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
          ...
          <div className="flex gap-4 items-center self-end">
            ...
            {role === "admin" && (
              ...
              // </button>
              <FormModle table="teachers" type="create" />
            )}
          </div>
        </div>
      </div>
      {/* LIST */}
      <Table columes={columes} rounderRow={rounderRow} data={teachersData} />
      {/* PAGINATION */}
      <Pagination />
    </section>
  );
