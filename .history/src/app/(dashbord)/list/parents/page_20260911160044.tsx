...
import TableSerach from "@/components/TableSerach";import prisma from "@/lib/prisma";
...
const rounderRow = (items: ParentList) => (
  <tr
    key={items.id}
  ...
  >
    ...
    <td className="hidden md:table-cell">
      {items.students.map((student) => student.name).join(",")}
    </td>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
          ...
          <div className="flex gap-4 items-center self-end">
            ...
            {role === "admin" && <FormModle table="parents" type="create" />}
          </div>
        </div>
      </div>
