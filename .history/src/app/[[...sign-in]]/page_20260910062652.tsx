...
const LoginPage = () => {
  ...
  const {isLoaded , isSingIn , user} = useUser()
  ...
  ';lkjhnvcxzxcvbnm,./          <Clerk.Input type="text" required className="p-2 rounded-md ring-1 ring-gray-300"/>
